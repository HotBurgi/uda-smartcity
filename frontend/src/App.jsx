...
const ProtectedRoute = ({ children, allowedRoles }) => {
  ...
  if (user === undefined) return <div>Loading...</div>; // Still checking auth? In context we handle loading
    ...
    <Routes>
      ...
      <Route element={<Layout />}>
        ...
        <Route path="/admin/history" element={
          <ProtectedRoute allowedRoles={['admin']}><AdminHistory /></ProtectedRoute>
        } />
        <Route path="/admin/trends/:areaId" element={
          <ProtectedRoute allowedRoles={['admin']}><AdminTrends /></ProtectedRoute>
        } />
      </Route>
